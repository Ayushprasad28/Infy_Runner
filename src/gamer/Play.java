...
{
    Character player;
    Texture texture1, texture2, texture3, down_small, down_med, down_big, up_small, up_med, up_big, score,spikes,spikes1,one,two,three,b1,b2,end;
    int nblock,wid,counter,save,run_pose,jumpy,outx1,outx2,outx3,once,trigger;
    double count,framerate,x1,x2,x3,x11,x31,add,add1,bspeed,del,del1,x4,x5,x6,x41,x51;
    long t1;
    double t;
    boolean pause1;
    boolean done,out;
